...
# Saida
print("         Salario Bruto: (%.f * %.f) :        R$ %5.2f" %(valorHora, quantHora, salario))
print("         (-) IR (5%%) :                       R$ %5.2f" %ir)
print("         (-) INSS (10%%) :                   R$ %5.2f" %inss)
print("         (-) FGTS (11%%) :                   R$ %5.2f" %fgts)
print("         Total de descontos :               R$ %5.2f" %descontos)
print("         Salario Liquido :                  R$ %5.2f" %salLiquido)